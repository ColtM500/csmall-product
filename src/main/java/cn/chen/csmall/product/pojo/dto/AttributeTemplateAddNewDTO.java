...
public class AttributeTemplateAddNewDTO implements Serializable {
     ...
     * 属性模板名称
     */
    @ApiModelProperty(value = "属性模板名称", required = true, example = "小米手机的属性模板")
     ...
     * 属性模板名称的拼音
     */
    @ApiModelProperty(value = "相册名称", required = true, example = "小米手机的属性模板名称的拼音")
     ...
     * 关键词列表，各关键词使用英文的逗号分隔
     */
    @ApiModelProperty(value = "关键词列表名称", required = true, example = "小米手机的关键词列表")
     ...
     * 排序序号
     */
    @ApiModelProperty(value = "排序序号名称", required = true, example = "111")
